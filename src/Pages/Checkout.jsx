  ...
  if (cartItems.length === 0) {
    return (
      <div className="status-message">
        ...
        <p>Add medicines to your cart before proceeding to checkout.</p>
        ...
        <form className="checkout-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            {state.errors.fullName && (
              <span className="form-error">{state.errors.fullName}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {state.errors.mobile && (
              <span className="form-error">{state.errors.mobile}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {state.errors.address && (
              <span className="form-error">{state.errors.address}</span>
            )}
          </div>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              {state.errors.city && (
                <span className="form-error">{state.errors.city}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              {state.errors.state && (
                <span className="form-error">{state.errors.state}</span>
              )}
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            {state.errors.pincode && (
              <span className="form-error">{state.errors.pincode}</span>
            )}
          </div>
